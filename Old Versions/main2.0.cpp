...
int main()
{
    ...
    comp_split("0" , real , imag);
    //cout << real << " " << imag;

    //cout << comp_combine(400 , 0);

    rectangular(1 , 90 , real , imag);
    //cout << real << " " << imag;

    polar("1" , real , imag);
    //cout << real << " " << imag;

    //cout << comp_multiply("22323.2" , "1");

    //cout << cos(3.141/2);

    //cout << comp_divide("30+50i" , "48+200i");

    //cout << comp_power("3+4i" , 3);
